...
def worker_code(pnum, sim_obj, tree_policy, rollout_policy, uct_constant, sim_count, horizon, time_limit):
    sim_c = 0
...
class ThreadTPGMClass(absagent.AbstractAgent):
    myname = "UCT-TP-GM-THREAD"
    ...
    def create_copy(self):
        return ThreadTPGMClass(self.simulator.create_copy(), self.rollout_policy.create_copy(),
